...
SCHEMA_FIXTURES = {
    ...
    "edgp.csr.artifact.v1": (
        Path("docs/schemas/edgp.csr.artifact.v1.schema.json"),
        Path("tests/fixtures/csr-artifact-manifest.json"),
    ),
    ...
    "edgp.fixture.provenance.v1": (
        Path("docs/schemas/edgp.fixture.provenance.v1.schema.json"),
        Path("tests/fixtures/fixture-provenance.json"),
    ),
    ...
    "edgp.report.bundle.submission_plan.v1": (
        Path("docs/schemas/edgp.report.bundle.submission_plan.v1.schema.json"),
        Path("tests/fixtures/report-bundle-submission-plan.json"),
    ),
...
def test_graph_diff_schema_documents_top_findings() -> None:
    schema = json.loads(
        Path("docs/schemas/edgp.graph.diff.v1.schema.json").read_text(
            encoding="utf-8"
        )
