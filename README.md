...
metrics, a compact SVG preview, a filterable edge explorer, most-depended-upon
rankings, and a node metadata table. Graph snapshot reports also summarize edge
