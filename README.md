...
edgp rpm-repo-bundle --source repodata/repomd.xml --output-dir reports/rpm-repo --impact-node glibc --advisories advisories.json --public-advisory-feed osv.json
...
advisory overlays, normalized public advisory feed reports, static HTML, and a
verification manifest. This is the public-resource path toward
